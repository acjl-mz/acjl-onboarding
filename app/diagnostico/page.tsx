    ...
    <main className="min-h-screen bg-[var(--acjl-surface)] p-6">
      <div className="mx-auto max-w-2xl pt-16">
        <div className="rounded-2xl bg-white p-8 shadow-sm border border-black/5">
          ...
          <h1 className="mt-3 text-3xl font-semibold">Conheça a realidade da sua empresa</h1>
          ...
          <p className="mt-5 text-sm text-slate-500">Tempo estimado: 5–10 minutos.</p>
          <Link href="/diagnostico/inicio" className="mt-8 inline-block rounded-lg bg-slate-900 px-5 py-3 text-white">
            Começar diagnóstico
          </Link>
        </div>
      </div>
